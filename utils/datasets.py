...
def get_data(args):
	...
	if(args.dataset == 'cifar10'):
		...
		trainset = ucr_archive.UCRArchive(args.datadir, 'Crop', datasetType = 'TRAIN', noise = args.noise_percentage, transform=None)
		testset = ucr_archive.UCRArchive(args.datadir, 'Crop', datasetType = 'VAL', noise = args.noise_percentage, transform=None)              
		num_classes = 24 
		series_length = 46
